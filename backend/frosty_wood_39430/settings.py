"""
Django settings for frosty_wood_39430 project.
...
ROOT_URLCONF = 'frosty_wood_39430.urls'
...
WSGI_APPLICATION = 'frosty_wood_39430.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_wood_39430 API",
    "DESCRIPTION": "API documentation for frosty_wood_39430 App",
    "VERSION": "v1",
}
